...
(function(){
  const packages=[
    {id:'tintx-package-1',name:'Package 1 — 4 Door Window Shades',price:2499,image:'package-1.png',details:'4 Door Window Shades'},
    {id:'tintx-package-2',name:'Package 2 — 4 Door + Back WindScreen Shade',price:3600,image:'package-2.png',details:'4 Door Window Shades + Back WindScreen Shade'},
    {id:'tintx-package-3',name:'Package 3 — Full Coverage',price:4100,image:'package-3.png',details:'4 Door Window Shades + Back WindScreen Shade + Third Row Quarter Shades'}
  ];
    ...
    section.innerHTML=`
      ...
      <div class="tintx-package-grid">
        ${packages.map((pkg,index)=>`
          <article class="tintx-package-card${index===1?' is-popular':''}">
            <div class="tintx-package-image"><img src="${pkg.image}" alt="${pkg.name} TINTX shade package"></div>
  ...
  function bindButtons(){
    ...
    document.addEventListener('click',function(event){
      ...
      if(found) found.qty++;
      else cart.push({id:pkg.id,name:pkg.name,price:pkg.price,oldPrice:0,badge:'TINTX PACKAGE',models:[],image:pkg.image,description:pkg.details,qty:1});
